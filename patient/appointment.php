                                        ...
                                        for($q=0;$q<3;$q++){
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div style="width:100%;">
                                                        <div class="h3-search">
                                                                    Appointment Date: '.substr($appodate,0,30).'<br>
                                                                ...
                                                                <br>
                                                                <a href="?action=drop&id='.$appoid.'&title='.$title.'&doc='.$docname.'" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">Cancel Appointment</font></button></a>
                                                        </div>
